...
**Su macOS/Linux/WSL:**
```bash
GOOS=linux CGO_ENABLED=0 go build -a -o go_simulation/go_simulation go_simulation/mqtt_simulation.go
GOOS=linux CGO_ENABLED=0 go build -a -o go_to_timescale/mqtt_to_timescale go_to_timescale/mqtt_to_timescale.go
```

**Su Windows (PowerShell):**
```powershell
$env:GOOS="linux"; $env:CGO_ENABLED=0;  go build -o go_simulation/go_simulation go_simulation/mqtt_simulation.go
$env:GOOS="linux"; $env:CGO_ENABLED=0;  go build -o go_to_timescale/mqtt_to_timescale go_to_timescale/mqtt_to_timescale.go
```
